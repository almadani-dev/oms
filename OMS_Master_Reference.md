...
- **Still not audited (later phases):** users/roles/permissions and authentication (**9B.4**), attachments, backup/restore, report exports, and the Audit UI. There is still no Filament audit screen and no audit permission.

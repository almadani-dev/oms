...
## Corpus Check
- 510 files · ~268,646 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7097 nodes · 18367 edges · 309 communities (279 shown, 30 thin omitted)
...
Cohesion: 0.08
Nodes (16): CreateProjectCostBudget, EditProjectCostBudget, ListProjectCostBudgets, ViewProjectCostBudget, BackedEnum, Builder, Schema, Table (+8 more)
...
Cohesion: 0.06
Nodes (19): EditAccount, EditCurrency, EditExchangeRateHistory, CreatePartnerType, EditPartnerType, ViewPartnerType, PartnerTypeResource, BackedEnum (+11 more)
...
Cohesion: 0.08
Nodes (12): Schema, GeneralExpenseForm, Schema, CostsRelationManager, Schema, Table, Currency, BelongsTo (+4 more)
...
Cohesion: 0.05
Nodes (24): CurrencyResource, BackedEnum, Builder, Schema, Table, UnitEnum, CreateCurrency, ListCurrencies (+16 more)
...
Cohesion: 0.06
Nodes (21): AccountStatementPage, BackedEnum, Schema, StreamedResponse, UnitEnum, ComprehensiveFinancialTransactionsPage, StreamedResponse, BackedEnum (+13 more)
...
Cohesion: 0.05
Nodes (35): Table, AccountType, HasMany, BankType, BelongsTo, HasMany, ExchangeRateHistory, BelongsTo (+27 more)
...
Cohesion: 0.07
Nodes (14): ViewExchangeRateHistory, CreateGeneralExpense, Model, Schema, ViewGeneralExpense, ViewPartner, Schema, ViewProjectCostReceipt (+6 more)
...
Cohesion: 0.10
Nodes (13): AccountResource, BackedEnum, Builder, Schema, Table, UnitEnum, CreateAccount, ListAccounts (+5 more)
...
Cohesion: 0.10
Nodes (14): ExchangeRateHistoryResource, BackedEnum, Schema, Table, UnitEnum, ExchangeRateHistoriesTable, Table, GeneralExpenseResource (+6 more)
...
Cohesion: 0.11
Nodes (9): EditProjectCostReceipt, Model, BackedEnum, Builder, Table, UnitEnum, ProjectCostReceiptResource, Table (+1 more)
...
Cohesion: 0.04
Nodes (44): Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Commit Hash (+36 more)
...
Cohesion: 0.11
Nodes (18): Date, Date, Date, Date, Decision, Decision, Decision, Decision (+10 more)

### Community 258 - "Community 258"
Cohesion: 0.06
Nodes (30): Date, Date, Date, Date, Date, Date, Date, Prompt (+22 more)
...
Cohesion: 0.04
Nodes (27): Schema, Get, Schema, Set, ProjectCostBudgetsPaymentForm, Schema, Get, Schema (+19 more)
...
## Knowledge Gaps
- **226 isolated node(s):** `Current Context`, `Recent Changes`, `Important Notes`, `Sensitive Data Rules`, `Date` (+221 more)
...
- **Why does `_update()` connect `Community 58` to `Community 39`, `Community 40`, `Community 72`, `Community 45`, `Community 238`, `Community 80`, `User Management Pages`, `Community 85`, `Community 56`, `Community 25`, `Community 252`, `Community 94`, `Community 31`?**

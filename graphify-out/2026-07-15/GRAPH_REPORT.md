...
## Corpus Check
- 519 files · ~306,175 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 7450 nodes · 18937 edges · 420 communities (386 shown, 34 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 229 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `2599779e`
...
## Communities (420 total, 34 thin omitted)

### Community 0 - "Project Cost Budget Payments"
Cohesion: 0.05
Nodes (21): EditProjectCostBudgetsPayment, Model, ProjectCost, ProjectCostBudget, ListProjectCostBudgetsPayments, Schema, ViewProjectCostBudgetsPayment, BackedEnum (+13 more)
...
Cohesion: 0.07
Nodes (15): GeneralExpenseResource, BackedEnum, Builder, Schema, Table, UnitEnum, CreateGeneralExpense, GeneralExpense (+7 more)

### Community 8 - "Transaction CRUD Pages"
Cohesion: 0.06
Nodes (21): AccountTypeResource, BackedEnum, Builder, Schema, Table, UnitEnum, CreateAccountType, EditAccountType (+13 more)
...
Cohesion: 0.25
Nodes (6): AccountType, Currency, TestCase, Account, Transaction, TransactionLineDescriptionBuilderTest
...
Cohesion: 0.08
Nodes (15): ListTransactionLines, ViewTransactionLine, Schema, TransactionLineForm, Table, TransactionLinesTable, Model, Schema (+7 more)
...
Cohesion: 0.04
Nodes (43): Schema, Table, ProjectCostBudgetsPaymentsTable, Schema, Attachment, BelongsTo, BankType, BelongsTo (+35 more)
...
Cohesion: 0.06
Nodes (17): ViewAccount, ViewExchangeRateHistory, Schema, ViewGeneralExchange, Schema, ViewGeneralExpense, ViewPartner, ViewProjectSuper (+9 more)
...
Cohesion: 0.05
Nodes (23): EditExecutionPayment, Model, ProjectCostBudget, ProjectCostBudgetsPayment, ExecutionPaymentsTable, Table, GeneralExpensesTable, Table (+15 more)
...
Cohesion: 0.08
Nodes (15): AccountResource, BackedEnum, Builder, Schema, Table, UnitEnum, CreateAccount, Account (+7 more)

### Community 66 - "Community 66"
Cohesion: 0.09
Nodes (11): CreateGeneralExchange, GeneralExchange, Model, EditGeneralExchange, GeneralExchange, Model, ListGeneralExchanges, ListProjectCostReceipts (+3 more)
...
Cohesion: 0.12
Nodes (11): ExchangeRateHistoryResource, BackedEnum, Schema, Table, UnitEnum, CreateExchangeRateHistory, EditExchangeRateHistory, ListExchangeRateHistories (+3 more)
...
Cohesion: 0.08
Nodes (17): CreateProjectCostReceipt, Model, ProjectCost, Transaction, Schema, ViewProjectCostReceipt, BackedEnum, Builder (+9 more)
...
Cohesion: 0.18
Nodes (6): AccountType, HasMany, BaseTestCase, ExampleTest, TestCase, ExampleTest
...
Cohesion: 0.07
Nodes (20): Schema, UserForm, Table, UsersTable, BackedEnum, Schema, Table, UnitEnum (+12 more)
...
## Knowledge Gaps
- **319 isolated node(s):** `Master Reference Document (Single Source of Truth)`, `What it is`, `Who it's for`, `Working method (IMPORTANT for future sessions)`, `Tech stack` (+314 more)
...
- **Why does `$a()` connect `Community 28` to `Community 25`, `Community 82`, `Community 58`?**
  _High betweenness centrality (0.033) - this node is a cross-community bridge._
- **Why does `_update()` connect `Community 58` to `Community 292`, `Community 39`, `Community 40`, `Community 72`, `Community 45`, `Community 238`, `Community 80`, `User Management Pages`, `Community 214`, `Community 25`, `Community 28`, `Community 94`, `Community 31`?**

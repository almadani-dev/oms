...
## Corpus Check
- 822 files · ~501,390 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 12477 nodes · 31577 edges · 510 communities (373 shown, 137 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 1054 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `60e7749a`
...
1. `Decision Template` - 461 edges
2. `Task Template` - 409 edges
3. `User` - 349 edges
4. `BackupOperation` - 241 edges
5. `TestCase` - 206 edges
6. `Prompts Log` - 138 edges
7. `update()` - 136 edges
...
## Communities (510 total, 137 thin omitted)

### Community 0 - "Project Cost Budget Payments"
Cohesion: 0.00
Nodes (461): Date, Date, Date, Date, Date, Date, Date, Date (+453 more)

### Community 1 - "Exchange Rate History Resource"
Cohesion: 0.00
Nodes (409): Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Changed Files, Changed Files (+401 more)
...
Cohesion: 0.06
Nodes (34): Action, AttachmentController, Request, StreamedResponse, ExchangeRateHistory, BelongsTo, PartnerType, BelongsTo (+26 more)

### Community 6 - "Partner CRUD Pages"
Cohesion: 0.02
Nodes (95): AuditedActions, EditAccount, CreateAccountType, EditAccountType, CreateBankType, EditBankType, BankTypesTable, Table (+87 more)
...
Cohesion: 0.01
Nodes (137): Date, Date, Date, Date, Date, Date, Date, Date (+129 more)
...
Cohesion: 0.02
Nodes (76): AccountTypeResource, BackedEnum, Builder, Schema, Table, UnitEnum, ViewAccountType, AccountTypeForm (+68 more)

### Community 16 - "Transaction Super Type Pages"
Cohesion: 0.05
Nodes (21): CreateExecutionPayment, Model, CreateProjectCostBudgetsPayment, Model, EditProjectCostBudgetsPayment, Model, ListProjectCostBudgetsPayments, Schema (+13 more)

### Community 17 - "Transaction Type Pages"
Cohesion: 0.04
Nodes (26): AuditImmutableRecordException, BackupEncryptionException, BackupEnvelopeUnsupportedVersionException, self, BackupIntegrityException, BackupOperationException, DatabaseDumpException, NativeAttachmentMoveRunner (+18 more)

### Community 18 - "Settings Pages"
Cohesion: 0.04
Nodes (15): Panel, User, PermissionPolicy, Permission, UserPolicy, PermissionManagementService, Authenticatable, HasFactory (+7 more)

### Community 19 - "User Management Pages"
Cohesion: 0.04
Nodes (9): BackupOperation, BelongsTo, BackupJobsTest, BackupNotificationTest, BackupPermissionsAndModelTest, BackupRetentionServiceTest, RestoreCommandTest, RestoreMetadataUpserterTest (+1 more)
...
Cohesion: 0.06
Nodes (11): isActive(), isTerminal(), InvalidArgumentException, QueryException, RestoreOrchestratorTestFixtures, RestoreProcessLauncher, BackupTestCase, FakeProcessRunner (+3 more)
...
Cohesion: 0.04
Nodes (20): RestoreCommand, BackupSubsystemLock, LockMode, BackupSubsystemLockHandle, LockMode, AttachmentSwapHandle, self, activate() (+12 more)

### Community 24 - "Payment & Receipt Proof Images"
Cohesion: 0.09
Nodes (8): Partner, BelongsTo, HasMany, BelongsTo, HasMany, Project, ProjectObserver, CleanOperationalDataCommandTest
...
Cohesion: 0.03
Nodes (16): BaseTestCase, FilamentUser, AttachmentPathSafetyTest, CrudRedirectStandardStructureTest, LaravelRestoreDatabaseConnectionResetterTest, UserFilamentAccessTest, TestCase, BackupStatusTest (+8 more)
...
Cohesion: 0.05
Nodes (17): ExecutionPaymentsTable, Table, GeneralExchangesTable, Table, EditGeneralExpense, Model, GeneralExpensesTable, Table (+9 more)
...
Cohesion: 0.05
Nodes (10): AttachmentCollector, isNullable(), up(), ensureUserTrackingColumn(), up(), AttachmentCollectorTest, CrudPolicyBehaviorTest, StreamedResponse (+2 more)
...
Cohesion: 0.06
Nodes (22): AccountResource, BackedEnum, Builder, Schema, Table, UnitEnum, ViewAccount, AccountForm (+14 more)

### Community 70 - "Community 70"
Cohesion: 0.05
Nodes (20): AppServiceProvider, run(), ProcessRunResult, SymfonyProcessRunner, run(), self, RestoreMaintenanceModeException, LaravelArtisanCommandRunner (+12 more)

### Community 72 - "Community 72"
Cohesion: 0.04
Nodes (46): Next Steps, Pending Items, Previously Recommended Next Step (2026-07-15, operational data cleanup — DONE), Previously Recommended Next Step (2026-07-15, transaction descriptions), Previously Recommended Next Step (2026-07-16, execution payment credit account editable — DONE), Previously Recommended Next Step (2026-07-16, General Exchange form rearrangement — DONE), Previously Recommended Next Step (2026-07-16, responsive credit/debit account layout — DONE), Previously Recommended Next Step (2026-07-18, financial transaction balance guard + automated verification — DONE, committed) (+38 more)
...
Cohesion: 0.05
Nodes (7): PermissionInfolist, Schema, PermissionsTable, Table, PermissionRegistry, SyncPermissionsCommandTest, SystemRoleDefaultPermissionsTest
...
Cohesion: 0.08
Nodes (14): ListRoles, ViewRole, BackedEnum, Model, Schema, Table, UnitEnum, RoleResource (+6 more)
...
Cohesion: 0.05
Nodes (23): GeneralExpenseResource, BackedEnum, Builder, Schema, Table, UnitEnum, ListGeneralExpenses, Schema (+15 more)

### Community 99 - "Community 99"
Cohesion: 0.04
Nodes (28): AccountStatementPage, BackedEnum, Schema, StreamedResponse, UnitEnum, CreateAccount, Model, Account (+20 more)
...
Cohesion: 0.05
Nodes (18): ListAccounts, ListAccountTypes, ListBankTypes, ListCurrencies, ListExchangeRateHistories, ListFiscalYears, ListPartners, ListProjectCosts (+10 more)
...
Cohesion: 0.13
Nodes (5): AuditEvent, BelongsTo, AuditEventImmutabilityTest, AuditEventsMigrationTest, AuditTestCase
...
Cohesion: 0.09
Nodes (5): Builder, UnitEnum, UserResource, AuthorizationAcceptanceTest, ResourceHttpAuthorizationTest
...
Cohesion: 0.18
Nodes (7): AuditLogger, Throwable, AuditRecordRequest, AuditPersistenceException, Throwable, AuditValidationException, AuditFailureMode
...
Cohesion: 0.16
Nodes (5): Role, Schema, RoleForm, Role, RoleManagementService

### Community 137 - "Community 137"
Cohesion: 0.05
Nodes (15): ListPermissions, ViewPermission, Model, EditUser, Model, ViewUser, Schema, UserForm (+7 more)
...
Cohesion: 0.17
Nodes (5): AuditActorContext, Request, self, AuditActorType, AuditActorContextTest
...
Cohesion: 0.08
Nodes (12): ListProjectCostReceipts, BackedEnum, Builder, Schema, Table, UnitEnum, ProjectCostReceiptResource, Get (+4 more)
...
Cohesion: 0.14
Nodes (3): GeneralExchangeAccountValidationTest, ProjectCostBudgetsPaymentAccountValidationTest, BalanceGuardIntegrationTest
...
Cohesion: 0.10
Nodes (17): RestoreDiskSpaceEstimate, BackupScope, CurrentDatabaseSizeEstimator, RestoreDiskSpaceEstimator, FakeArtisanCommandRunner, acquireLock(), assertRestoredWithDiagnostics(), buildOrchestrator() (+9 more)
...
Cohesion: 0.20
Nodes (7): handleRecordCreation(), Model, handleRecordUpdate(), Model, AuditedCrudService, Model, Relation
...
Cohesion: 0.17
Nodes (6): AccountType, Partner, ProjectSuper, TestCase, AuditedCrudTestCase, User
...
Cohesion: 0.17
Nodes (3): PartnerType, AuditedFilamentCrudTest, AuditedFilamentLifecycleTest
...
Cohesion: 0.22
Nodes (9): 2. ARCHITECTURE, Accounting model (double-entry) — [DECISION], Audit Log foundation (OMS Task 9B.1 — schema/service layer; wired to general CRUD only as of 9B.2, see below), Audit Log — general CRUD integration (OMS Task 9B.2 — master-data models only), Bank types system, Data flow (money lifecycle), Database — core tables (~24, ALL use SoftDeletes), High-level structure (+1 more)
...
Cohesion: 0.38
Nodes (3): AuditActorResolver, AuditActorContext, Request
...
Cohesion: 0.67
Nodes (3): Corrections applied after the first 9B.2 review (2026-07-28), Open items carried out of 9B.2 (not defects, decisions to revisit), Recommended Next Step (2026-07-28, OMS Task 9B.2 — Audit Log general CRUD integration — implemented, verified, NOT yet committed)

## Knowledge Gaps
- **1304 isolated node(s):** `Master Reference Document (Single Source of Truth)`, `What it is`, `Who it's for`, `Working method (IMPORTANT for future sessions)`, `Tech stack` (+1299 more)
...
- **Why does `TestCase` connect `Community 35` to `Project Super Pages`, `Transaction Line Pages`, `Transaction Super Type Pages`, `Transaction Type Pages`, `Settings Pages`, `General Financial Page & CSV Export`, `Projects Report Page Queries`, `Payment & Receipt Proof Images`, `Community 31`, `Community 58`, `Community 62`, `Community 63`, `Community 66`, `Community 67`, `Community 70`, `Community 82`, `Community 83`, `Community 90`, `Community 92`, `Community 94`, `Community 96`, `Community 97`, `Community 98`, `Community 99`, `Community 100`, `Community 104`, `Community 110`, `Community 111`, `Community 114`, `Community 116`, `Community 117`, `Community 120`, `Community 133`, `Community 136`, `Community 137`, `Community 138`, `Community 141`, `Community 150`, `Community 154`, `Community 157`, `Community 162`, `Community 169`, `Community 174`, `Community 175`, `Community 179`, `Community 180`, `Community 181`, `Community 186`, `Community 187`, `Community 191`, `Community 196`, `Community 198`, `Community 200`, `Community 203`, `Community 204`, `Community 205`, `Community 208`, `Community 213`, `Community 214`, `Community 215`, `Community 221`, `Community 222`, `Community 223`, `Community 224`, `Community 225`, `Community 228`, `Community 229`, `Community 238`, `Community 239`, `Community 240`, `Community 241`, `Community 242`, `Community 243`, `Community 246`, `Community 248`, `Community 251`, `Community 254`, `Community 258`, `Community 260`, `Community 261`, `Community 276`, `Community 278`, `Community 279`, `Community 280`, `Community 292`, `Community 293`, `Community 302`?**
  _High betweenness centrality (0.085) - this node is a cross-community bridge._
- **Why does `User` connect `Settings Pages` to `Community 258`, `Community 131`, `Project Super Pages`, `Community 136`, `Community 137`, `Community 143`, `Transaction Line Pages`, `Community 273`, `Transaction Super Type Pages`, `Community 275`, `User Management Pages`, `General Financial Page & CSV Export`, `Community 149`, `Community 278`, `Payment & Receipt Proof Images`, `Community 160`, `Community 35`, `Community 292`, `Community 293`, `Community 167`, `Community 169`, `Community 43`, `Community 175`, `Community 306`, `Community 178`, `Community 54`, `Community 182`, `Community 183`, `Community 58`, `Community 186`, `Community 187`, `Community 62`, `Community 63`, `Community 67`, `Community 68`, `Community 196`, `Community 201`, `Community 203`, `Community 205`, `Community 82`, `Community 83`, `Community 212`, `Community 213`, `Community 214`, `Community 217`, `Community 90`, `Community 92`, `Community 93`, `Community 221`, `Community 222`, `Community 223`, `Community 98`, `Community 99`, `Community 104`, `Community 238`, `Community 239`, `Community 240`, `Community 241`, `Community 117`, `Community 118`, `Community 246`, `Community 120`, `Community 122`, `Community 251`, `Community 252`, `Community 254`?**
  _High betweenness centrality (0.042) - this node is a cross-community bridge._
- **Why does `BackupOperation` connect `User Management Pages` to `Community 256`, `Project Super Pages`, `Community 263`, `Community 142`, `Community 273`, `Settings Pages`, `General Financial Page & CSV Export`, `Community 150`, `Projects Report Page Queries`, `Community 277`, `Community 153`, `Community 149`, `Community 160`, `Community 167`, `Community 168`, `Community 170`, `Community 43`, `Community 172`, `Community 304`, `Community 306`, `Community 178`, `Community 52`, `Community 53`, `Community 54`, `Community 183`, `Community 68`, `Community 211`, `Community 216`, `Community 217`, `Community 218`, `Community 93`, `Community 228`, `Community 115`, `Community 118`, `Community 252`?**
  _High betweenness centrality (0.032) - this node is a cross-community bridge._
- **Are the 90 inferred relationships involving `User` (e.g. with `.table()` and `.configure()`) actually correct?**
